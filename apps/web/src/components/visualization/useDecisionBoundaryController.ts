...
export function useDecisionBoundaryController() {
    ...
    return { model, showTestData, discretize, showHelp, guidanceLevel, overlayMode, overlayCopy: getDecisionOverlayCopy(overlayMode, showTestData, discretize), commands };
}
