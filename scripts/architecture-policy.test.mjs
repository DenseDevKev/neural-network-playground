...
const cases = [
    ...
    ['retired legacy layout cannot own saves', 'apps/web/src/components/layout/MainArea.tsx', "import { useSaveCurrentRun } from '../../hooks/useSaveCurrentRun.ts'; export { useSaveCurrentRun };", true],
    ...
    ['standalone history wrapper remains an exact exception', 'apps/web/src/components/controls/RunHistoryPanel.tsx', "import { useSaveCurrentRun } from '../../hooks/useSaveCurrentRun.ts'; export { useSaveCurrentRun };", false],
